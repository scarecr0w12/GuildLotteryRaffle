...
local L = AceLocale:NewLocale("GuildLotteryRaffle", "zhCN")
...
L["GLR - Core - Disabled Message"] = "插件已关闭, 请打开插件来开始一个新的 彩票/抽奖"
L["GLR - Core - Disabled No Guild Message"] = "你必须在一个公会里来使用这个插件."
L["GLR - Core - Invalid Raffle Item"] = "检测到了无效抽奖物品"
L["GLR - Core - Critical Update Detected"] = "请重启魔兽世界以更新重要的新版本插件."

-- Addon Error/Completion Message Translations
L["GLR - Error - Zero Entries"] = "无法以零个条目开始活动"
L["GLR - Error - No Jackpot"] = "无法开始一个没有奖金的活动!"
L["GLR - Error - No Entries Found"] = "找不到条目"
L["GLR - UI > Config > Events - Confirm Cancel"] = "确认取消"
L["GLR - UI > Config - Confirm Action"] = "确认动作"
L["GLR - UI > Config > Events - Confirm Cancel Desc"] = "需要确认来取消当前活动"
L["GLR - Core - Confirm Cancel False"] = "复选框必须打勾, 来确认您需要取消当前活动."
L["GLR - Core - Lottery Canceled Message"] = "当前彩票活动已取消"
L["GLR - Core - Raffle Canceled Message"] = "当前抽奖活动已取消"
L["GLR - Core - AddOn Loaded Message"] = "公会彩票&抽奖插件版本 %version 成功加载"
L["GLR - Error - Cant Create Calendar Events"] = "你无法创建公会活动. 请联系您的公会会长来了解具体情况."
L["GLR - Error - Calendar Events Disabled"] = "日历活动的创建已被禁用. 请打开它 (开启日历活动) 来创建一个公会日历活动."
L["GLR - Core - Initialization Complete"] = "初始化完成! 名单数据已更新."
L["GLR - Core - Invalid Player Entry Detected"] = "%n - 未能检测这名玩家为一个有效的条目; 他们已被从当前 %e 活动移除."

-- Addon Slash Command Detection
L["Toggle"] = "开关"

-- Addon Communication Message Translations
L["GLR - Comms - Your Version Outdated"] = "您的版本 %version_current 已过期. 最新版本 %version_new 已经可以被下载."
L["GLR - Comms - Others Version Outdated"] = "%name 拥有一个过期版本的插件. 告诉他们去升级吧!"

-- Ticket Giveaway Message Translations
L["GLR - Core - Ticket Giveaway"] = "免费票券! 玩家将会收到票券, 这取决于 %PlayerTickets %word (从当前的 %name 活动)."
L["GLR - Core - Ticket Giveaway Rank Based"] = "这些等阶的玩家将收到免费票券!"
L["GLR - Core - Ticket Giveaway Singular"] = "票券"
L["GLR - Core - Ticket Giveaway Plural"] = "票券"
L["GLR - UI > Config > Giveaway - Select Event"] = "选择活动"
L["GLR - UI > Config > Giveaway - Type"] = "选择赠送方式"
L["GLR - UI > Config > Giveaway - Type Desc"] = "选项有:\n- 所有人\n- 等阶筛选\n\n如果选择等阶筛选, 你需要在下面选择哪些等阶是有效可以收到免费票券的."
L["GLR - UI > Config > Giveaway - Online"] = "在线状态"
L["GLR - UI > Config > Giveaway - Online Desc"] = "如果设置为当前在线, 这将只会赠送票券给当前在线公会玩家.\n\n如果你正在举行多个公会活动并且设置这个为任意的 '最近 X 天', 将不能保证其准确性, 因为您的角色在线时将会保存链接公会的上次在线数据.\n\n'当前在线' 在多个工会活动的情况下不可用."
L["GLR - UI > Config > Giveaway - Start"] = "开始赠送"
L["GLR - UI > Config > Giveaway - Start Desc"] = "这个过程将持续一段时间"
L["GLR - UI > Config > Giveaway - Tickets"] = "赠送票券"
L["GLR - UI > Config > Giveaway - Tickets Desc"] = "输入的数量将会被赠予给所有的有效条目, 最多为 %t 个票券"
L["GLR - UI > Config > Giveaway - No Event Active"] = "没有一个激活的活动"
L["GLR - UI > Config > Giveaway - Everyone"] = "所有人"
L["GLR - UI > Config > Giveaway - By Rank"] = "等阶筛选"
L["GLR - UI > Config > Giveaway - Currently Online"] = "当前在线"
L["GLR - UI > Config > Giveaway - 7 Days"] = "最近 7 天"
L["GLR - UI > Config > Giveaway - 14 Days"] = "最近 14 天"
L["GLR - UI > Config > Giveaway - 21 Days"] = "最近 21 天"
L["GLR - UI > Config > Giveaway - 28 Days"] = "最近 28 天"
L["GLR - UI > Config > Giveaway - Names Available"] = "有效的条目名字"
L["GLR - UI > Config > Giveaway - Select Rank"] = "设置等阶"
L["GLR - UI > Config > Giveaway - Select Guild"] = "设置公会与等阶"
L["GLR - UI > Config > Giveaway - Select Ranks Desc"] = "设置什么等阶可以获得票券."
L["GLR - UI > Config > Giveaway - Select Guild Desc"] = "设置什么公会的什么等阶可以获得票券.\n\n可以多选工会."

-- Data Export Translations
L["GLR - UI > StaticPopupDialog - Copy Text"] = "复制以下内容到你的剪贴板 (CTRL+C):"
L["GLR - UI > Config > Events > Data Export - Button"] = "导出数据"
L["GLR - UI > Config > Events > Data Export - Button Tooltip"] = "导出前一个 %e 活动数据"

-- Event Settings Translations
L["GLR - UI > Config > Events > Raffle - Inverse Announce Order"] = "反向公告顺序"
L["GLR - UI > Config > Events > Raffle - Inverse Announce Order Tooltip"] = "默认情况下, 播报抽奖赢家时, 插件第一个播报:\n   1等 -> 2等 -> 3等\n通过勾选该复选框, 插件将会反向播报:\n   3等 -> 2等 -> 1等"

-- Frame Title Font String Translations
L["Guild Lottery & Raffles"] = true -- Title of the mod. Set to true as it won't be translated.
L["GLR - UI > Main - Lottery & Raffle Info"] = "彩票 & 抽奖信息" -- Lottery Info Frame Title
L["GLR - UI > Main - Player Ticket Information"] = "玩家票券信息" -- Lottery Player Name Frame Title
L["GLR - UI > Main - Ticket Pool"] = "票券池" -- Unused Ticket Frame Title
L["GLR - UI > Main - Ticket Number Range"] = "票券数字范围" -- Ticket Number Range Frame Title
L["GLR - UI > Config > Options > Tickets - View Ticket Info Title"] = "查看玩家票券"
L["GLR - UI > UpdateFrame - New Update"] = "插件已更新"

-- Lottery & Raffle Translation
L["Lottery"] = "彩票"
L["Raffle"] = "抽奖"
L["Guild Lottery"] = "公会彩票" -- Currently used for Mail Subject text detection
L["Guild Raffle"] = "公会抽奖" -- Currently used for Mail Subject text detection
L["Both"] = "两者都"
L["Value_Gold"] = "金币"
L["Value_Silver"] = "银币"
L["Value_Copper"] = "铜币"
...
L["Detect Lottery"] = "!彩票"
L["Detect Raffle"] = "!抽奖"
L["Detect Other Lottery"] = "?彩票"
L["Detect Other Raffle"] = "?抽奖"

L["GLR - Core - Reply - Detect Other Event: Notify Player (long msg)"] = "GLR: 以下玩家申请了您的 %e 当前活动票券信息:"
L["GLR - Core - Reply - Detect Other Event: Notify Player (short msg)"] = "GLR: %users 申请了您的 %e 当前活动票券信息."
L["GLR - Core - Reply - Detect Other Event: Target Found"] = "GLR: '%target' 在当前 %e 活动中 买了 %num 个票券. 他们的票券范围从 %low 到 %high."
L["GLR - Core - Reply - Detect Other Event: No One Found"] = "GLR: '%target' 没有进入一个活动或者无法被找到. 如果您正在搜索的玩家已经进入了活动, 请正确输入他的名字."
L["GLR - Core - Reply - Detect Other Event: No Valid Text"] = "GLR: 请输入一个名字来获取他们已购买票券的信息. 例如: ?%event %host"
L["GLR - Core - Reply - Detect Other Event: Multiple Found"] = "GLR: 从您的搜索关键字中检测到多个可能的名字 '%target' 请更详细的拼写您要搜索玩家的名字. 例如: ?%event %host"
...
L["GLR - Core - Calendar Lottery Title"] = "公会彩票"
L["GLR - Core - Calendar Raffle Title"] = "公会抽奖"
L["GLR - Core - Calendar Guild Announcement"] = "票券为: %TicketPrice 每个.                                   每个人可以购买 %MaxTickets 个票券.           联系: %Player 来获取更多细节."

-- Button Font String Translations
L["New Lottery Button"] = "新建彩票"
L["New Raffle Button"] = "新建抽奖"
L["Begin Lottery Button"] = "开始彩票"
L["Begin Raffle Button"] = "开始抽奖"
L["Alert Guild Button"] = "提醒公会"
L["New Player Button"] = "新建玩家"
L["Edit Players Button"] = "编辑玩家"
L["Configure Button"] = "设置"
L["Go To Raffle Button"] = "切换为抽奖"
L["Go To Lottery Button"] = "切换为彩票"
L["Confirm Start Button"] = "确认开始"
L["Start New Lottery Button"] = "开始彩票"
L["Start New Raffle Button"] = "开始抽奖"
L["Confirm Add Player Button"] = "新增玩家"
L["Confirm Edit Player Button"] = "编辑玩家"
L["Confirm Action Button"] = "确认"
L["Confirm Add Raffle Item"] = "OK"
L["Abort Roll"] = "取消 Roll"
L["Confirm Abort Roll"] = "确认取消"
L["Scan Mail Button"] = "扫描邮件"
L["Reply Mail Button"] = "回复"
...
L["Lottery Name"] = "彩票名称"
L["Raffle Name"] = "抽奖名称"
L["Starting Gold"] = "开始金额"
L["Raffle First Place"] = "一等奖"
L["Raffle Second Place"] = "二等奖"
L["Raffle Third Place"] = "三等奖"
L["Raffle Sales"] = "票券价格"
L["Jackpot"] = "头奖"
L["Raffle Second Place"] = "二等奖"
L["Max Tickets"] = "最大票券数"
L["Ticket Price"] = "票券价格"
L["Second Place Text"] = "二等"
L["Guild Amount Text"] = "公会数量"
L["Winner Guaranteed"] = "保证有获胜者"

-- New Lottery Frame Font String Translations
L["New Lottery Settings"] = "新增彩票设置"
L["Select Valid Lottery Date"] = "为新增彩票设置一个有效的日期"
L["Hour"] = "小时:"
L["Minute"] = "分钟:"
L["Set Lottery Name"] = "设置彩票名"
L["Set Starting Gold"] = "设置开始金额"
L["Set Maximum Tickets"] = "设置最大票券数量"
L["Set Ticket Price"] = "设置票券价格"
L["Set Second Place Prize"] = "设置二等奖"
L["Set Guild Cut"] = "设置公会份额"
...
L["Raffle Draw Step 1"] = "Raffle Prize(s)"
L["Raffle Draw Step 1 Prize 1"] = "First Place Prize: %p1"
L["Raffle Draw Step 1 Prize 2"] = "Second Place Prize: %p2"
L["Raffle Draw Step 1 Prize 3"] = "Third Place Prize: %p3"
-- Step 2
...
L["Send Info Event Info 1"] = "Event Info For"
L["Send Info Event Info 2"] = "on"
L["Send Info Player Lottery Entered"] = "You've entered into a Lottery scheduled for"
L["Send Info Player Raffle Entered"] = "You've entered into a Raffle scheduled for"
L["Send Info No Tickets Purchased Part 1"] = "You've not purchased any Tickets for"
L["Send Info No Tickets Purchased Part 2"] = "If this is a mistake please let me know."
L["Send Info Can Purchase Tickets Part 1"] = "You are able to purchase"
L["Send Info Can Purchase Tickets Part 2"] = "Tickets at"
L["Send Info Can Purchase Tickets Part 3"] = "per Ticket."
L["Send Info Reply Lottery"] = "To see info about your purchased tickets please message me with '!lottery' after you've been entered."
L["Send Info Reply Raffle"] = "To see info about your purchased tickets please message me with '!raffle' after you've been entered."
L["Send Info Tickets Purchased First Msg 1"] = "You've purchased"
L["Send Info Tickets Purchased First Msg 2"] = "out of the"
L["Send Info Tickets Purchased First Msg 3"] = "Ticket Limit"
L["Send Info Tickets Purchased Part 1"] = "You've purchased"
...
L["Send Info Max Tickets Part 1"] = "You've purchased the maximum of"
L["Send Info Max Tickets Part 2"] = "Tickets."
L["Send Info Long Ticket Message"] = "Your Ticket numbers are (long message):"
L["Send Info GLR"] = "GLR"
L["Send Info Current Jackpot Part 1"] = "After the Guilds cut of"
L["Send Info Current Jackpot Part 2"] = "The current Jackpot is"
L["Send Info Current Prizes"] = "The Current Raffle Prize(s) are"
L["Send Info Short Ticket Message"] = "Your Ticket Numbers are"
L["Send Info Ticket Number Range"] = "Your tickets range from: %first to %last"
...
L["Send Info No Active Event"] = "No %event is currently active."
L["Send Info No Active Lottery"] = "No Lottery is currently active."
L["Send Info No Active Raffle"] = "No Raffle is currently active."
...
--L["Configuration Panel Message Tab Formats"] = "Available Formats:\n  %%state_price -> Becomes the Ticket Cost for your Event.\n  %%state_max -> Becomes the Maximum Tickets for your Event.\n  %%state_name -> Becomes the Name of your Event.\n  %%state_date -> Becomes the Date for your Event.\n  %%state_gold -> Becomes the Jackpot for your Event.\n                         (or Gold raised for Raffles)\n  %%state_tickets -> Becomes the number of Tickets Sold.\n  %%state_reply -> Becomes the detection phrase.\n  %version -> Becomes the current version of the AddOn."
--L["Configuration Panel Message Tab Formats Part 2"] = "\n  %previous_winner -> Becomes the Winners Name of your Previous Event.\n  %previous_jackpot -> Becomes the amount the Previous Winner won."
...
L["Configuration Panel Options Toggle Chat Info"] = "Toggle Chat Info"
L["Configuration Panel Options Toggle Chat Info Desc"] = "Toggles On/Off extra information that's sent to your chat frame. Such as detailed Mail Scanning process."
L["Configuration Panel Options Toggle Full Ticket Info"] = "Toggle Full Ticket Info"
...
L["Configuration Panel Options Multi-Guild Description"] = "To begin the process of linking Multiple Guilds together you must enable the 'Multi-Guild Events' option in General Settings. This must be done on at least two characters in different Guilds to set their status as Linked. To host a Lottery or Raffle for the Linked Guilds, you must host it on a character you've Linked."
...
L["Configuration Panel No Guild Cut on No Winner"] = "No Guild Cut"
